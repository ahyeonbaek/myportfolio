  ...
  return (
    <div>
      ...
      <div className={style.contents_about_main}>
        ...
        <div className={style.contents_about_introduce}>
          <p>안녕하세요.</p>
          <div>
            <p>
              1️⃣ <span>"사용자의 편리성을 중점으로 한 서비스"</span>와
            </p>
            <p>
              2️⃣ <span>"깔끔한 UI/UX" </span>를 만들기 위해 노력하는
            </p>
          ...
          <p>
            ...
            주로 vite 환경에서 react typescript 로 <br />
            작업하였고, 사용친화적인 react ui컴포넌트를 <br />
            만들기위해 노력하였습니다. <br />
            또한 엘리스 리액트 트랙2기를 수료하며,
            <br />
            진행했던 팀 프로젝트에서 협업하는 방식과 <br />
            서버와의 통신 흐름을 익혔습니다.
          </p>
          <p>
            배울수록 느끼는 것은 배움에는 끝이없다는 것입니다. <br />
